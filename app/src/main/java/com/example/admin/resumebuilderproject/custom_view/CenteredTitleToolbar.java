package com.example.admin.resumebuilderproject.custom_view;
...
public class CenteredTitleToolbar extends Toolbar {
    ...
    private void init() {
        ...
        _titleTextView.setTextAppearance(getContext(), R.style.ToolBarStyle_Event);
        _titleTextView.setText(R.string.resume_builder);
